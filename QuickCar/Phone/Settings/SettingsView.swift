    ...
    var body: some View {
        ...
        NavigationStack {
            List {
                ...
                Section(String(localized: "settings.appearance", table: "Localizable")) {
                    Picker(String(localized: "settings.theme", table: "Localizable"), selection: $settings.themeMode) {
                        ForEach(ThemeMode.allCases, id: \.self) { mode in
                            Text(String(localized: String.LocalizationValue(mode.displayKey), table: "Localizable")).tag(mode)
                        }
                    }
                }
