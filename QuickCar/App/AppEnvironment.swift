...
final class AppEnvironment: ObservableObject {
    ...
    let vehicleProfile: VehicleProfileStore
    ...
    private init() {
        ...
        let profileStore = VehicleProfileStore(settings: settings)
        let care = CareCoordinator(settings: settings, modelContext: context, announcer: announcer, profileStore: profileStore)
        let dtcMonitor = DTCMonitor(
            obd: obd,
            settings: settings,
            alertEngine: alerts,
        ...
        self.vehicleProfile = profileStore
